...
\author{\normalsize Dominic Baril$^{1}$, Simon-Pierre Deschênes$^{1}$, Luc Coupal$^{1}$, Cyril Goffin, \\Julien Lépine$^{1}$, Philippe Giguère$^{1}$, François Pomerleau$^{1}$} % Author(s)} % Author(s)
...
\newcommand{\rightfoot}{dominic.baril@norlab.ulaval.ca} % Right footer text
