...
\begin{itemize}
	...
	\item Facilitating and automating the task of gathering a training dataset is of high importance for field operations.
\end{itemize}
\end{block}
...
\begin{block}{\acf{DRIVE}}
	...
	\end{figure}
		...
		\item Random uniform input sampling minimizes input bias and stimulates dynamic, transitory behavior.
